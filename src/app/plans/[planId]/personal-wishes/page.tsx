  ...
  return (
    <div>
      <textarea id={id} placeholder={placeholder} rows={rows}
        style={{ width: "100%", boxSizing: "border-box" as const, padding: "10px 13px", borderRadius: 10, border: `1.5px solid ${error ? "#c0392b" : "#e7e5e4"}`, background: error ? "#fff8f7" : "#fff", fontFamily: "system-ui, sans-serif", fontSize: "0.9rem", color: "#1c1917", outline: "none", resize: "vertical" as const, lineHeight: 1.6 }}
...
export default function PersonalWishesPage() {
  ...
  useEffect(() => { reset(plan.personalWishes); }, [plan.personalWishes, reset]);
  ...
  const wishFields = [
    { id: "importantToMe", name: "importantToMe" as const, label: "What is important to me", placeholder: "Your hopes, fears, practical matters (e.g. you like the TV on, you like to be outside), family concerns, spiritual care you would like, anything else you can think of…", hint: "Include anything that matters to you day-to-day." },
    { id: "meaningfulToMe", name: "meaningfulToMe" as const, label: "What makes life meaningful to me", placeholder: "Your values, the people and pets who matter to you, how you'd like those caring for you to look after your spiritual and emotional needs…", hint: "Think about what brings you joy and a sense of purpose." },
    { id: "familyAndFriendsMessage", name: "familyAndFriendsMessage" as const, label: "What I want my family and friends to know and remember", placeholder: "Memories, messages, things left unsaid, what you hope they'll carry forward…", hint: "This is your chance to speak directly to those you love." },
  ];
    ...
    <div style={{ minHeight: "100vh", background: "linear-gradient(160deg, #fdf8f3 0%, #f5ede0 50%, #fdf8f3 100%)" }}>
      <div style={{ maxWidth: 520, margin: "0 auto", padding: "0 16px 96px" }}>
        ...
        <div style={{ padding: "20px 0 28px" }}>
          ...
          <h1 style={{ fontFamily: "Georgia, serif", fontSize: "1.5rem", fontWeight: 700, color: "#1c1917", margin: "0 0 6px" }}>Personal Wishes</h1>
