    ...
    <div style={{ minHeight: "100vh", background: "linear-gradient(160deg, #fdf8f3 0%, #f5ede0 50%, #fdf8f3 100%)" }}>
      <div style={{ maxWidth: 520, margin: "0 auto", padding: "0 16px 96px" }}>
        ...
        <div style={{ padding: "20px 0 28px" }}>
          ...
          <p style={{ fontFamily: "system-ui, sans-serif", fontSize: "0.85rem", color: "#78716c", margin: 0, lineHeight: 1.5 }}>{t("bodyCareSubtitleAlt")}</p>
        </div>
        ...
        <form onBlur={onFieldBlur} onSubmit={handleSubmit((data) => updateSection({ bodyCareFuneral: data }))} noValidate>
          ...
          <div style={{ background: "#fff", borderRadius: 14, border: "1px solid #e7e5e4", padding: 18, marginBottom: 16 }}>
            <p style={{ fontFamily: "Georgia, serif", fontSize: "0.95rem", fontWeight: 600, color: "#1c1917", margin: "0 0 14px" }}>{t("burialPreference")}</p>
            <div style={{ display: "flex", gap: 10 }}>
              {[{ value: "buried", label: t("buriedLabel") }, { value: "cremated", label: t("crematedLabel") }].map(opt => {
          ...
          <div style={{ background: "#fff", borderRadius: 14, border: "1px solid #e7e5e4", padding: 18 }}>
            <p style={{ fontFamily: "Georgia, serif", fontSize: "0.95rem", fontWeight: 600, color: "#1c1917", margin: "0 0 6px" }}>{t("funeralWishesLabel")}</p>
            <p style={{ fontFamily: "system-ui, sans-serif", fontSize: "0.75rem", color: "#a8a29e", margin: "0 0 12px", lineHeight: 1.4 }}>{t("funeralWishesHint")}</p>
            <TextareaInput id="funeralWishes" placeholder={t("funeralWishesPlaceholder2")} rows={5} {...register("funeralWishes")} />
          </div>
        </form>
      </div>
